...
public class Licenca implements Entity<Licenca, Protocolo> {
	...
	public String mensagensDeAviso() {
		...
		if(mensagemDeAcordoSituacao.getId().equals(Status.StatusEnum.ATIVO_AGUARDANDO_PAGAMENTO.id)){
			return "VÁLIDO EM TODO O ESTADO DO AMAPÁ, MEDIANTE APRESENTAÇÃO DE DOCUMENTO DE IDENTIDADE E COMPROVANTE DE PAGAMENTO, RESPEITANDO AS REGRAS DE PESCA DO LOCAL";
		} else{
			return "VÁLIDO EM TODO O ESTADO DO AMAPÁ, MEDIANTE APRESENTAÇÃO DE DOCUMENTO DE IDENTIDADE, RESPEITANDO AS REGRAS DE PESCA DO LOCAL";
		}
	}
	...
	public String descricaoCarteiraDefinitivaEProvisoria() {
		...
		if(mensagemDeAcordoSituacao.getId().equals(Status.StatusEnum.ATIVO_AGUARDANDO_PAGAMENTO.id)){
			return "LICENÇA PROVISÓRIA PARA PESCA AMADORA ESTADO DO AMAPÁ";
		} else{
			return "LICENÇA PARA PESCA AMADORA ESTADO DO AMAPÁ";
		}
	}
