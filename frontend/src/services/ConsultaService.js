...
const ConsultaService = {
  ...
  buscarRemessas: paginaAtual => {
    return ApiService.getWithBlock(`${Properties.BASE_URL}/banco/lista-remessa?page=` + (paginaAtual - 1));
  },
  buscarArquivosRetornos: paginaAtual => {
    return ApiService.getWithBlock(`${Properties.BASE_URL}/banco/lista-retornos?page=` + (paginaAtual - 1));
  },
  /**
