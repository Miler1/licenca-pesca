...
const GERAL = {
  ...
  remessa: {
    tituloRetorno: ["Arquivos de retorno", ""],
    tituloRemessa: ["Arquivos de remessa", ""],
    nomeArquivoRemessa: ["Nome do arquivo", ""],
    listagemRemessa: ["Listagem dos arquivos de remessa", ""],
    dataArquivoRemessa: ["Data de criação", ""],
    acao: ["Ação", ""],
